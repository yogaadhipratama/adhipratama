export const projects = [
  {
    title: 'Developers Social-Hub',
    description: "Build an in depth full stack social network application using Node.js, Express, React, Redux and MongoDB along with ES6+",
      image: '/images/1.png',
      tags: ['Mongo', 'Express', 'React', 'NodeJS'],
    source: 'https://google.com',
    visit: 'https://social4developers.herokuapp.com/',
    id: 0,
  },
  {
    title: 'E-Commerce',
